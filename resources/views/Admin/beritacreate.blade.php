        ...
        <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-7">
                ...
                <div class="space-y-1.5 group">
                    ...
                    <div class="relative flex items-center">
                        ...
                        <select name="kategori" required
                            ...
                            <option value="Kesehatan" {{ old('kategori') == 'Kesehatan' ? 'selected' : '' }}>Layanan Kesehatan</option>
                            <option value="Kegiatan" {{ old('kategori') == 'Kegiatan' ? 'selected' : '' }}>Kegiatan Puskesmas</option>
                            <option value="Pengumuman" {{ old('kategori') == 'Pengumuman' ? 'selected' : '' }}>Pengumuman Penting</option>
                        </select>
                ...
                <div class="space-y-1.5 group">
                    ...
                    <p class="text-[10px] text-gray-400 font-medium ml-1">Format: JPG, JPEG, PNG, WEBP. Maksimal ukuran file: 2 MB.</p>
                ...
                <div class="space-y-1.5 group">
                    ...
                    <div class="relative">
                        <textarea name="konten" id="newsTextArea" rows="9" required
                            ...
                            placeholder="Tuliskan isi atau rincian berita secara lengkap dan jelas di sini...">{{ old('konten') }}</textarea>
                    </div>
